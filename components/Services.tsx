    ...
    <section id="services" className="py-32 bg-[#080808] border-t border-white/5">
        <div className="max-w-7xl mx-auto px-6">
            <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
                 <div>
                    <h2 className="text-sm text-accent font-mono uppercase tracking-widest mb-4">Services</h2>
                    <h3 className="text-4xl md:text-6xl font-display font-bold">How I can help</h3>
                 </div>
                 <p className="text-muted max-w-sm text-right md:text-left">
                    Comprehensive technical solutions for scaling businesses. From architecture to deployment.
                 </p>
            </div>
                ...
                {SERVICES.map((service, idx) => {
                    ...
                    return (
                        <div key={idx} className="service-card group bg-surface p-8 rounded-2xl border border-white/5 hover:bg-surfaceHighlight transition-all duration-300">
                            ...
                            <p className="text-muted mb-8 leading-relaxed h-20">{service.description}</p>
                            
                            <div className="space-y-2">
                                <h5 className="text-xs font-bold uppercase tracking-wider text-white/50 mb-4">Process</h5>
