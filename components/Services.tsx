...
export const Services: React.FC = () => {
  ...
  return (
    <section id="services" className="py-32 bg-background border border-white/10">
        <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {services.map((service, idx) => {
                    ...
                    return (
                        <div key={idx} className="service-card group bg-surface p-8 rounded-2xl border border-white/10 hover:bg-surfaceHighlight transition-all duration-300">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {service.steps[language].map(step => (
                                        <span key={step} className="text-xs border border-white/10 px-2 py-1 rounded text-muted">
                                            {step}
                                        </span>
                                    ))}
                                </div>
