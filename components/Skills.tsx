  ...
  return (
    <section id="stack" className="py-32 px-6 max-w-7xl mx-auto">
      <div className="text-center mb-20">
         <h2 className="text-sm text-accent font-mono uppercase tracking-widest mb-4">Tech Stack</h2>
         <h3 className="text-4xl md:text-5xl font-display font-bold">Tools of the Trade</h3>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {SKILLS.map((category, idx) => (
            <div key={idx} className="group relative bg-surface p-8 rounded-3xl border border-white/5 hover:border-accent/50 transition-colors duration-300">
                ...
                <h4 className="text-2xl font-bold mb-8 relative z-10">{category.category}</h4>
